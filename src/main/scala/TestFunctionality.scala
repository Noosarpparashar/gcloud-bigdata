...
object TestFunctionality extends App {
  ...
  val conf = new SparkConf()
    ...
    .set("spark.sql.catalog.spark_catalog.uri", "thrift://10.58.192.29:9083")  // Your Hive metastore
  ...
  val icebergTable = "spark_catalog.default.yvideos_vvld3" // Your Iceberg table
